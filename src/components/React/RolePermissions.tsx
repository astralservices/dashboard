  ...
  return (
    <>
      <div className="grid grid-cols-3 col-span-full">
        <div className="flex rounded-l-md shadow-sm col-span-2">
      ...
      {perms.roles &&
        Object.entries(perms.roles).map(([role, perm], i) => (
          <div className="grid grid-cols-2 col-span-full">
            <div className="flex rounded-l-md shadow-sm col-span-1">
              <span className="inline-flex items-center px-3 text-white rounded-l-md bg-black-400 sm:text-sm">
                @
              </span>
              <input
                type="text"
                readOnly
                value={roles.find((r) => r.id === role)?.name || role}
                className="flex-1 block w-full min-w-0 px-1 py-2 border-none rounded-none bg-black-400 sm:text-sm"
              />
            </div>
            ...
            <div className="col-span-1">
              <ReactChip
                ...
                inputClass="bg-black-300 text-white px-3 py-2 border-none rounded-r-md w-full"
